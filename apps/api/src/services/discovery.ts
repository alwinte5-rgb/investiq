...
const SCREENS: { key: string; title: string; blurb: string; criteria: ScreenCriteria }[] = [
  ...
  {
    key: "mid-cap-growth",
    title: "Mid-cap movers",
    blurb: "$2B–$20B companies — less mega-cap, more growth potential and more risk.",
    criteria: { marketCapMoreThan: 2_000_000_000, marketCapLowerThan: 20_000_000_000, betaMoreThan: 1, isEtf: false, limit: 8 },
  },
  {
    key: "small-cap",
